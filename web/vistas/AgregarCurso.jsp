                ...
                <table  class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input class="form-horizontal" type="text" name="f_horas" value="" maxlength="11" size="11" /></td>
                        </tr>
                        <tr>
                            <td class="text-right">Creditos</td>
                            <td><input class="form-horizontal" type="text" name="f_creditos" value="" maxlength="11" size="11" /></td>
                        </tr>
                        <tr>
