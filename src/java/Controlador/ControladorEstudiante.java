...
public class ControladorEstudiante extends HttpServlet{
    String listarestudiante = "vistas/ListarEstudiante.jsp";
    String agregarestudiante = "vistas/AgregarEstudiante.jsp";
    String editarestudiante = "vistas/EditarEstudiante.jsp";
